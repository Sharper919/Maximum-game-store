    ...
    return (
        <div className="game-screen">
            ...
            <div className="about-this-game">
                ...
                <hr />
                <p>Experience a new epic story filled with action and thrilling adventure. Explore the open world of feudal Japan, from spectacular fortress cities and bustling ports to tranquil shrines and war-torn landscapes. You'll experience unpredictable weather, changing seasons, and environments that react to your actions. Take on the roles of the shinobi assassin Naoe and the legendary samurai Yasuke, learn their incredible stories, and master their complementary playstyles.</p>
                <img src={assassi1} alt="assassi1" />
                <p>Take on the roles of the shinobi assassin Naoe and the legendary samurai Yasuke, learn their incredible stories, and master their complementary playstyles.</p>
